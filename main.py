...
def confidence_interval(data, func=np.mean, size=1000, ci=95, seed=1234):
...
def main():
    ...
    group_expr.add_argument('-s', '--seed', type=int, default=123, help='initial random seed')
